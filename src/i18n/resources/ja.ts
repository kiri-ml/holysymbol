...
export const ja = {
  ...
  snapshot: {
    entered: '入力済み',
    refreshed: '更新済み',
    emptyPrompt: '経験値を取得または入力',
    fetchStartExp: '開始時の経験値を取得',
    refreshExp: '経験値を更新',
  ...
  tip: {
    updateExpBeforeRefreshing: '更新する前にゲーム内で経験値を最新にしてください：',
  ...
  aria: {
    ...
    estimateExpPercent: '{{label}}経験値（%）',
    expPerMesoRatio: 'メルあたりの経験値比率',
    hourlyPriceMillions: '時間単価、単位は百万メル',
    expRateMillions: '1時間あたりの経験値、単位は百万',
    ...
    markBuyerDone: '{{name}}を完了にする',
    reopenBuyer: '{{name}}を再開する',
    removeBuyer: '{{name}}を削除',
    runExpRatio: 'このランのメルあたり経験値比率',
    ratioTierLevel: '比率ティア{{number}}の最低レベル',
    ratioTierRatio: '比率ティア{{number}}のメルあたり経験値比率',
  ...
  confirm: {
    ...
    cancel: 'キャンセル',
    confirm: '確認',
    refreshSnapshot: '{{label}}の経験値を更新しますか？現在のレベルと経験値データが上書きされます。',
  ...
  csv: {
    ...
    buyer: '買い手',
    startLevel: '開始レベル',
    startExpPercent: '開始時の経験値（%）',
    startTime: '開始時刻',
    currentLevel: '現在レベル',
    currentExpPercent: '現在の経験値（%）',
    currentTime: '現在時刻',
    expGained: '獲得経験値',
    mesosDue: '請求メル',
    billableMs: '課金ミリ秒',
