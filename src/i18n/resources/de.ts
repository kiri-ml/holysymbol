...
export const de = {
  ...
  buyer: {
    ...
    done_one: '{{count}} abgeschlossen',
    done_other: '{{count}} abgeschlossen',
  ...
  aria: {
    ...
    markBuyerDone: '{{name}} als abgeschlossen markieren',
    reopenBuyer: '{{name}} wieder öffnen',
    removeBuyer: '{{name}} entfernen',
    runExpRatio: 'EXP-pro-Meso-Verhältnis des Runs',
    ratioTierLevel: 'Mindestlevel der Preisstufe {{number}}',
    ratioTierRatio: 'EXP-pro-Meso-Verhältnis der Preisstufe {{number}}',
    removeRatioTier: 'Preisstufe {{number}} entfernen',
